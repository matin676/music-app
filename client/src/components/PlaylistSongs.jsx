          ...
          <div className="w-full max-w-[1200px] p-3 md:p-4 flex flex-col gap-4 md:gap-8">
            ...
            <div className="w-full flex flex-col md:flex-row gap-4 md:gap-8 items-center md:items-end p-4 md:p-6 bg-white/20 backdrop-blur-xl border border-white/20 rounded-2xl md:rounded-3xl shadow-xl">
              ...
              <div className="flex flex-col gap-2 flex-1 items-start text-center md:text-left w-full">
                <span className="text-xs md:text-sm font-bold uppercase text-white/80 tracking-widest">
                  Playlist
                </span>
            ...
            <div className="flex flex-col w-full bg-white/20 backdrop-blur-md border border-white/20 rounded-xl md:rounded-2xl overflow-hidden shadow-lg p-3 md:p-4">
              {/* Table Header */}
              <div className="grid grid-cols-[auto_1fr_auto] md:grid-cols-[auto_1fr_1fr_auto] gap-3 md:gap-4 px-3 md:px-4 py-2 border-b border-gray-200/50 text-gray-500 font-semibold text-xs md:text-sm uppercase tracking-wider mb-2">
              ...
              <div className="flex flex-col gap-2">
                {selectedSongs.map((song, index) => (
                  <motion.div
                    ...
                    className="group grid grid-cols-[auto_1fr_auto] md:grid-cols-[auto_1fr_1fr_auto] gap-3 md:gap-4 items-center px-3 md:px-4 py-2 md:py-3 rounded-lg md:rounded-xl hover:bg-white/40 cursor-pointer transition-colors"
                  ...
                  >
                    ...
                    <span className="hidden md:block text-gray-500 text-sm text-right">
                      {moment(selectedPlaylist.createdAt).fromNow()}
                    </span>
                  </motion.div>
                ))}
              </div>
