...
export default function AlertSuccess({ msg }) {
  return (
    <motion.div
    ...
    >
      <div className="bg-white/90 backdrop-blur-xl border border-green-200/50 px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-4 min-w-[300px] max-w-[90vw] pointer-events-auto">
