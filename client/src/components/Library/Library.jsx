      ...
      <main className="w-full p-3 md:p-4 flex flex-col items-center max-w-[1200px]">
        {!user ? (
          <div className="w-full h-[60vh] flex flex-col items-center justify-center gap-4 animate-fadeIn">
            ...
            <NavLink
              to="/login"
              className="px-6 py-2 bg-blue-500 text-white rounded-full font-semibold hover:bg-blue-600 transition-colors shadow-lg"
            >
              Login Now
            </NavLink>
          </div>
                    ...
                    >
                      ...
                      <div className="p-2 md:p-3 flex items-center justify-between flex-1 bg-white/30 backdrop-blur-sm">
                        ...
                        <div className="flex items-center gap-1 z-10 shrink-0">
                          <button
                            className="p-1.5 md:p-2 hover:bg-green-100 rounded-full text-gray-500 hover:text-green-500 transition-colors"
                            onClick={(e) => {
                              e.preventDefault();
                              e.stopPropagation();
                              setPlaylistToEdit(data);
                            }}
                          >
                            <IoPencil className="text-base md:text-lg" />
                          </button>
                          <button
                            className="p-1.5 md:p-2 hover:bg-red-100 rounded-full text-gray-500 hover:text-red-500 transition-colors"
                            onClick={(e) => {
                              e.preventDefault();
                              e.stopPropagation();
